...
;(function ($) {
      ...
      if (currMenuType !== menuType) {
        ...
        if (currMenuType === 'mobile') {
          ...
          var logomobileMenu = $('#mainnav-mobi')
            ...
            .first()
            .before(
              '<li id="logo" class="logo-mobi"><a href="index.html"><img src="images/logo/my.jpg" alt="images" data-width="122" data-height="34" data-retina="images/logo/my.jpg"></a></li>',
            )
  ...
  var pp_custom2 = function () {
    $('.pp-scrollable').scroll(function () {
      ...
      if (
        $('.slide-personal-intro').hasClass('active') &&
        $(this).scrollTop() == 0
      ) {
        $('.header').removeClass('header-shadow')
      }
